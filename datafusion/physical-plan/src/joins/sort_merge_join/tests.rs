...
use crate::{expressions::Column, joins::sort_merge_join::stream::JoinedRecordBatches};
...
fn build_joined_record_batches() -> Result<JoinedRecordBatches> {
    ...
    // For Inner Join, we don't need row_indices and batch_ids
...
// Removed test_left_outer_join_filtered_mask - not applicable for Inner Join only implementation
